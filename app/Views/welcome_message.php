...
<head>
    ...
    <style {csp-style-nonce}>
        ...
        *:focus {
        ...
        header li.product-item a:hover,
        header li.product-item a:focus {
            background-color: rgba(221, 72, 20, .2);
        ...
        header .product-toggle button:hover,
        header .product-toggle button:focus {
