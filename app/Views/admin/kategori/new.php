...
<?= $this->section('title'); ?>
<title>Tambah Data Kategori | SPT</title>
<?= $this->endSection(); ?>
  ...
  <section class="section mt-2">
    <div class="card">
      <div class="card-body">
        ...
        <form action="<?= site_url('kategori'); ?>" class="form" method="POST" autocomplete="off">
          <div class="row">
            <?= csrf_field(); ?>
            <div class="col-md-6 col-12">
              <div class="form-group">
                <label>Nama Kategori <strong class="text-danger">*</strong></label>
                <input type="text" class="form-control <?= $validation->hasError('nama_kategori') ? 'is-invalid' : null ?>" name="nama_kategori" value="<?= old('nama_kategori'); ?>">
